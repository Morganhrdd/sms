...
class QuestionAdmin(admin.ModelAdmin):
    list_display = ['Content', 'TypeByObjective', 'TypeByLength', 'Marks', 'DifficultyLevel', 'ExpectedTime', 'Standard', 'Subject']
    search_fields = ['Content', 'TypeByObjective', 'TypeByLength', 'Marks', 'DifficultyLevel', 'ExpectedTime', 'Standard', 'Subject']
