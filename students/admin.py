...
class CoCurricularAdmin(admin.ModelAdmin):
    ...
    search_fields = ('StudentYearlyInformation__StudentBasicInfo__RegistrationNo','StudentYearlyInformation__StudentBasicInfo__FirstName', 'Activity', 'Guide')
...
class ElocutionAdmin(admin.ModelAdmin):
    ...
    search_fields = ['Title','StudentYearlyInformation__StudentBasicInfo__RegistrationNo', 'StudentYearlyInformation__StudentBasicInfo__FirstName', 'StudentYearlyInformation__StudentBasicInfo__LastName']
