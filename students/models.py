...
class PhysicalFitnessInfo(models.Model):
    ...
    SBJ = models.FloatField()
    VerticleJump = models.FloatField()
    BallThrow = models.FloatField()
    ShuttleRun = models.FloatField()
    SitUps = models.PositiveIntegerField()
    Sprint = models.FloatField()
    Running400m = models.FloatField()
    ShortPutThrow = models.FloatField()
